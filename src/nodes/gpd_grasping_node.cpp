...
int main(int argc, char **argv)
{
  ...
  // manipulation.move_group_ptr->setGoalPositionTolerance(0.01);
  // manipulation.move_group_ptr->setGoalOrientationTolerance(0.002);
  ...
  while (ros::ok())
  {
    ...
    */
    ...
    // Move the object to a specific postion
    manipulation.goPostGrasp();
    ros::Duration(3.0).sleep();
    manipulation.open_gripper();
    ros::Duration(3.0).sleep();

    // Go back to the scan position for repeating, get a new grasp
    manipulation.goTop();
